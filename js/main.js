define(["os_map", "points", "params", "jquery"],
    function(os_map, points, params, $) {
		...
		if (locationsFromUrl != null) {
			...
			points.add(418678, 385093, 'http://trigpointing.uk/trig/6995', 'Winhill Pike');
			points.add(422816, 385344, 'http://trigpointing.uk/trig/3795', 'High Neb');
			points.add(419762, 390990, 'http://trigpointing.uk/trig/949', 'Back Tor');
			points.add(412927, 387809, 'http://trigpointing.uk/trig/3019', 'Edale Moor');
		}
